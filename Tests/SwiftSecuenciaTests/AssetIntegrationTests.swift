...
@Test func timelineAllAssetsReturnsUniqueAssets() async throws {
  ...
  let audio1 = TypedDataStorage(
    providerId: "test", requestorID: "a1", mimeType: "audio/mpeg", binaryValue: Data())
  let audio2 = TypedDataStorage(
    providerId: "test", requestorID: "a2", mimeType: "audio/wav", binaryValue: Data())
  let video1 = TypedDataStorage(
    providerId: "test", requestorID: "v1", mimeType: "video/mp4", binaryValue: Data())
  ...
  timeline.insertClip(
    TimelineClip(assetStorageId: audio1.id, duration: Timecode(seconds: 10)), at: .zero)
  timeline.insertClip(
    TimelineClip(assetStorageId: audio1.id, duration: Timecode(seconds: 10)),
    at: Timecode(seconds: 10))
  timeline.insertClip(
    TimelineClip(assetStorageId: audio2.id, duration: Timecode(seconds: 5)),
    at: Timecode(seconds: 20))
  timeline.insertClip(
    TimelineClip(assetStorageId: video1.id, duration: Timecode(seconds: 30)), at: .zero)
...
@Test func timelineAudioAssetsFiltersAudio() async throws {
  ...
  let audio = TypedDataStorage(
    providerId: "test", requestorID: "a", mimeType: "audio/mpeg", binaryValue: Data())
  let video = TypedDataStorage(
    providerId: "test", requestorID: "v", mimeType: "video/mp4", binaryValue: Data())
  ...
  // Add clips
  timeline.insertClip(
    TimelineClip(assetStorageId: audio.id, duration: Timecode(seconds: 10)), at: .zero)
  timeline.insertClip(
    TimelineClip(assetStorageId: video.id, duration: Timecode(seconds: 30)), at: .zero)
...
@Test func timelineImageAssetsFiltersImages() async throws {
  ...
  let image = TypedDataStorage(
    providerId: "test", requestorID: "i", mimeType: "image/png", binaryValue: Data())
  let video = TypedDataStorage(
    providerId: "test", requestorID: "v", mimeType: "video/mp4", binaryValue: Data())
  ...
  // Add clips
  timeline.insertClip(
    TimelineClip(assetStorageId: image.id, duration: Timecode(seconds: 5)), at: .zero)
  timeline.insertClip(
    TimelineClip(assetStorageId: video.id, duration: Timecode(seconds: 30)), at: .zero)
...
@Test func timelineValidateAllAssetsDetectsInvalid() async throws {
  ...
  let validAsset = TypedDataStorage(
    providerId: "test", requestorID: "valid", mimeType: "audio/mpeg", binaryValue: Data())
...
@Test func timelineClipsWithAssetIdFindsClips() async throws {
  ...
  timeline.insertClip(
    TimelineClip(assetStorageId: assetId1, duration: Timecode(seconds: 10)), at: .zero)
  timeline.insertClip(
    TimelineClip(assetStorageId: assetId1, duration: Timecode(seconds: 10)),
    at: Timecode(seconds: 10))
  timeline.insertClip(
    TimelineClip(assetStorageId: assetId2, duration: Timecode(seconds: 5)),
    at: Timecode(seconds: 20))
