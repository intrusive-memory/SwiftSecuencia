...
@Test func autoLaneAssignmentUsesPreferredWhenAvailable() async throws {
  ...
  let placement = try timeline.insertClipAutoLane(
    clip2, at: Timecode(seconds: 15), preferredLane: 0)
...
@Test func autoLaneAssignmentThrowsWhenDisabledAndConflict() async throws {
  ...
  do {
    _ = try timeline.insertClipAutoLane(
      clip2, at: Timecode(seconds: 5), preferredLane: 0, autoAssignLane: false)
...
@Test func findAvailableLaneSearchesOutward() async throws {
  ...
  let availableLane = timeline.findAvailableLane(
    at: .zero, duration: Timecode(seconds: 10), startingFrom: 0)
...
@Test func laneRangeWithMultipleLanes() async throws {
  ...
  timeline.insertClip(
    TimelineClip(assetStorageId: UUID(), duration: Timecode(seconds: 5)), at: .zero, lane: -2)
  timeline.insertClip(
    TimelineClip(assetStorageId: UUID(), duration: Timecode(seconds: 5)), at: .zero, lane: 0)
  timeline.insertClip(
    TimelineClip(assetStorageId: UUID(), duration: Timecode(seconds: 5)), at: .zero, lane: 3)
...
@Test func placementsOnLaneFiltersCorrectly() async throws {
  ...
  timeline.insertClip(
    TimelineClip(assetStorageId: UUID(), duration: Timecode(seconds: 5)), at: .zero, lane: 0)
  timeline.insertClip(
    TimelineClip(assetStorageId: UUID(), duration: Timecode(seconds: 5)), at: .zero, lane: 1)
