...
public struct MediaProbe: Sendable {
    ...
    public func mimeType(of fileURL: URL) -> String {
        ...
        // Unknown extension
        default:
            Self.logger.warning("Unknown file extension '\(ext)' for file '\(fileURL.lastPathComponent)'. Returning application/octet-stream.")
    ...
    public func probeMissingDurations(in definition: TimelineDefinition) async throws -> TimelineDefinition {
