...
public struct TimingData: Codable, Sendable {
  ...
  public init(
    version: String = "1.0", audioFile: String, duration: Double, segments: [TimingSegment]
  ) {
...
public struct TimingSegment: Codable, Sendable, Equatable, Hashable {
  ...
  public init(
    id: String, startTime: Double, endTime: Double, text: String? = nil,
    metadata: TimingMetadata? = nil
  ) {
    self.id = id
