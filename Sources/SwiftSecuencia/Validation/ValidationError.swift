...
//  SwiftSecuencia
//
//  Validation errors for FCPXML documents and timelines.
//

import Foundation

/// Validation error for FCPXML documents.
public struct ValidationError: Sendable, Equatable, Hashable {
    ...
    /// Optional context information (e.g., clip ID, asset ID).
...
/// Validation warning for FCPXML documents.
